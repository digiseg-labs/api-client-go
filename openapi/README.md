...
<div class=\"api-clients\">
  ...
  <a class=\"api-client-box\" href=\"https://github.com/digiseg-labs/api-client-ts\">
    ...
    <p>API client for<br/>TypeScript</p>
  </a>
  <a class=\"api-client-box\" href=\"https://github.com/digiseg-labs/api-client-go\">
    ...
    <p>API client for<br/>Go</p>
  </a>
  <a class=\"api-client-box\" href=\"https://github.com/digiseg-labs/api-client-dotnet\">
    <i class=\"api-client-sdk-logo devicon-dot-net-plain\"></i>
    <p>API client for<br/>.NET</p>
  </a>
</div>
...
*EnrichmentAPI* | [**CreateEnrichmentJob**](docs/EnrichmentAPI.md#createenrichmentjob) | **Post** /enrichment/jobs | Create enrichment job
*EnrichmentAPI* | [**DeleteEnrichmentJob**](docs/EnrichmentAPI.md#deleteenrichmentjob) | **Delete** /enrichment/jobs/{id} | Delete enrichment job
*EnrichmentAPI* | [**DeleteEnrichmentJobResultData**](docs/EnrichmentAPI.md#deleteenrichmentjobresultdata) | **Delete** /enrichment/jobs/{id}/result | Delete enrichment job result data
*EnrichmentAPI* | [**DeleteEnrichmentJobSourceData**](docs/EnrichmentAPI.md#deleteenrichmentjobsourcedata) | **Delete** /enrichment/jobs/{id}/source | Delete enrichment job source data
*EnrichmentAPI* | [**DownloadResultFile**](docs/EnrichmentAPI.md#downloadresultfile) | **Get** /enrichment/jobs/{id}/result/file | Download enriched file
*EnrichmentAPI* | [**GetEnrichmentJobById**](docs/EnrichmentAPI.md#getenrichmentjobbyid) | **Get** /enrichment/jobs/{id} | Get enrichment job by ID
*EnrichmentAPI* | [**ListEnrichmentJobs**](docs/EnrichmentAPI.md#listenrichmentjobs) | **Get** /enrichment/jobs | List enrichment jobs
*EnrichmentAPI* | [**PreviewEnrichmentJobSourceData**](docs/EnrichmentAPI.md#previewenrichmentjobsourcedata) | **Get** /enrichment/jobs/{id}/source/preview | Preview the source data
*EnrichmentAPI* | [**StartEnrichmentJob**](docs/EnrichmentAPI.md#startenrichmentjob) | **Post** /enrichment/jobs/{id}/start | Start enrichment job
*EnrichmentAPI* | [**UpdateEnrichmentJob**](docs/EnrichmentAPI.md#updateenrichmentjob) | **Put** /enrichment/jobs/{id} | Update enrichment job
*EnrichmentAPI* | [**UploadEnrichmentJobSourceData**](docs/EnrichmentAPI.md#uploadenrichmentjobsourcedata) | **Post** /enrichment/jobs/{id}/source | Upload source data to enrichment job
...
*SubscriptionsAPI* | [**GetSubscriptionPlanFree**](docs/SubscriptionsAPI.md#getsubscriptionplanfree) | **Get** /subscription_plans/free | Gets the default/free subscription plan
...
*TaxonomyAPI* | [**GetAudience**](docs/TaxonomyAPI.md#getaudience) | **Get** /taxonomy/audiences/{audience_code} | Get an audience by its code
*TaxonomyAPI* | [**GetCategory**](docs/TaxonomyAPI.md#getcategory) | **Get** /taxonomy/categories/{category_code} | Get a category by its code
...
*UsageAPI* | [**ListDataDailyUsage**](docs/UsageAPI.md#listdatadailyusage) | **Get** /usage/{data}/daily | List daily usage of Audience Data
*UsageAPI* | [**ListDataMonthlyUsage**](docs/UsageAPI.md#listdatamonthlyusage) | **Get** /usage/{data}/monthly | List monthly usage of Audience Data
*UsageAPI* | [**ListDataRealtimeUsage**](docs/UsageAPI.md#listdatarealtimeusage) | **Get** /usage/{data}/realtime | List realtime usage of Audience Data
...
## Documentation For Models
 ...
 - [AudienceBuilderSegmentItem](docs/AudienceBuilderSegmentItem.md)
 - [AudienceCategoryItem](docs/AudienceCategoryItem.md)
 - [AudienceCategoryRef](docs/AudienceCategoryRef.md)
 ...
 - [AudienceResponse1](docs/AudienceResponse1.md)
 - [AudienceResponseMeta](docs/AudienceResponseMeta.md)
 ...
 - [CategoryListResponseMeta](docs/CategoryListResponseMeta.md)
 ...
 - [DataDailyUsage](docs/DataDailyUsage.md)
 - [DataMonthlyUsage](docs/DataMonthlyUsage.md)
 - [DataRealtimeUsage](docs/DataRealtimeUsage.md)
 - [DataUsage](docs/DataUsage.md)
 - [DayOfMonthStats](docs/DayOfMonthStats.md)
 - [DayOfWeekStats](docs/DayOfWeekStats.md)
 - [EnrichmentJobAux](docs/EnrichmentJobAux.md)
 - [EnrichmentJobBase](docs/EnrichmentJobBase.md)
 - [EnrichmentJobFileSource](docs/EnrichmentJobFileSource.md)
 - [EnrichmentJobFull](docs/EnrichmentJobFull.md)
 - [EnrichmentJobItem](docs/EnrichmentJobItem.md)
 - [EnrichmentJobListResponse](docs/EnrichmentJobListResponse.md)
 - [EnrichmentJobResult](docs/EnrichmentJobResult.md)
 - [EnrichmentJobSingleResponse](docs/EnrichmentJobSingleResponse.md)
 - [EnrichmentJobSortOption](docs/EnrichmentJobSortOption.md)
 - [EnrichmentJobSourceDataColumnDefinition](docs/EnrichmentJobSourceDataColumnDefinition.md)
 - [EnrichmentJobSourceDataPreview](docs/EnrichmentJobSourceDataPreview.md)
 - [EnrichmentJobSourceDataPreviewResponse](docs/EnrichmentJobSourceDataPreviewResponse.md)
 - [EnrichmentJobStatus](docs/EnrichmentJobStatus.md)
 - [EnrichmentJobUpdate](docs/EnrichmentJobUpdate.md)
 ...
 - [GetSubscriptionPlanFree200Response](docs/GetSubscriptionPlanFree200Response.md)
 ...
 - [ListAudiences200ResponseOneOf](docs/ListAudiences200ResponseOneOf.md)
 - [ListAudiences200ResponseOneOf1](docs/ListAudiences200ResponseOneOf1.md)
 - [ListCountries200Response](docs/ListCountries200Response.md)
 - [ListDataDailyUsage200Response](docs/ListDataDailyUsage200Response.md)
 - [ListDataMonthlyUsage200Response](docs/ListDataMonthlyUsage200Response.md)
 - [ListDataRealtimeUsage200Response](docs/ListDataRealtimeUsage200Response.md)
 ...
 - [OAuthCallbackResponseData](docs/OAuthCallbackResponseData.md)
 - [OAuthRegistrationRequest](docs/OAuthRegistrationRequest.md)
 - [OAuthRegistrationResponseData](docs/OAuthRegistrationResponseData.md)
 - [OAuthRegistrationToken](docs/OAuthRegistrationToken.md)
 ...
 - [StudyAIImportantNumber](docs/StudyAIImportantNumber.md)
 - [StudyAISummary](docs/StudyAISummary.md)
 ...
 - [SubscriptionPlanFree](docs/SubscriptionPlanFree.md)
