...
`func (o *AccountBase) SetCustomPlatformUrl(v string)`

SetCustomPlatformUrl sets CustomPlatformUrl field to given value.

### HasCustomPlatformUrl

`func (o *AccountBase) HasCustomPlatformUrl() bool`
