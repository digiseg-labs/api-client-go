...
`func (o *StudyItem) GetBannerImageUrl() string`

GetBannerImageUrl returns the BannerImageUrl field if non-nil, zero value otherwise.

### GetBannerImageUrlOk

`func (o *StudyItem) GetBannerImageUrlOk() (*string, bool)`
...
`func (o *StudyItem) SetBannerImageUrl(v string)`

SetBannerImageUrl sets BannerImageUrl field to given value.

### HasBannerImageUrl

`func (o *StudyItem) HasBannerImageUrl() bool`
