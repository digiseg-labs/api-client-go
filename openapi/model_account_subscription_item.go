...
// checks if the AccountSubscriptionItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountSubscriptionItem{}

// AccountSubscriptionItem struct for AccountSubscriptionItem
type AccountSubscriptionItem struct {
...
type _AccountSubscriptionItem AccountSubscriptionItem
...
func (o AccountSubscriptionItem) MarshalJSON() ([]byte, error) {
...
func (o AccountSubscriptionItem) ToMap() (map[string]interface{}, error) {
...
func (o *AccountSubscriptionItem) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountSubscriptionItem := _AccountSubscriptionItem{}

	err = json.Unmarshal(data, &varAccountSubscriptionItem)

	if err != nil {
		return err
	}

	*o = AccountSubscriptionItem(varAccountSubscriptionItem)
...
type NullableAccountSubscriptionItem struct {
	value *AccountSubscriptionItem
	isSet bool
}

func (v NullableAccountSubscriptionItem) Get() *AccountSubscriptionItem {
	return v.value
}

func (v *NullableAccountSubscriptionItem) Set(val *AccountSubscriptionItem) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountSubscriptionItem) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountSubscriptionItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountSubscriptionItem(val *AccountSubscriptionItem) *NullableAccountSubscriptionItem {
	return &NullableAccountSubscriptionItem{value: val, isSet: true}
}

func (v NullableAccountSubscriptionItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountSubscriptionItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
