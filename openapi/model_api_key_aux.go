...
func (o *ApiKeyAux) UnmarshalJSON(data []byte) (err error) {
	varApiKeyAux := _ApiKeyAux{}

	err = json.Unmarshal(data, &varApiKeyAux)

	if err != nil {
		return err
	}

	*o = ApiKeyAux(varApiKeyAux)
