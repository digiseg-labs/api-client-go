...
func (o *ApiKeyBase) UnmarshalJSON(data []byte) (err error) {
	varApiKeyBase := _ApiKeyBase{}

	err = json.Unmarshal(data, &varApiKeyBase)

	if err != nil {
		return err
	}

	*o = ApiKeyBase(varApiKeyBase)
