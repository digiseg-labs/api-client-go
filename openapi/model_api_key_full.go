...
// checks if the ApiKeyFull type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiKeyFull{}
...
func (o ApiKeyFull) MarshalJSON() ([]byte, error) {
...
func (o ApiKeyFull) ToMap() (map[string]interface{}, error) {
...
func (o *ApiKeyFull) UnmarshalJSON(data []byte) (err error) {
	varApiKeyFull := _ApiKeyFull{}

	err = json.Unmarshal(data, &varApiKeyFull)

	if err != nil {
		return err
	}

	*o = ApiKeyFull(varApiKeyFull)
...
func (v NullableApiKeyFull) Get() *ApiKeyFull {
	return v.value
}

func (v *NullableApiKeyFull) Set(val *ApiKeyFull) {
	v.value = val
	v.isSet = true
}

func (v NullableApiKeyFull) IsSet() bool {
	return v.isSet
}

func (v *NullableApiKeyFull) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiKeyFull(val *ApiKeyFull) *NullableApiKeyFull {
	return &NullableApiKeyFull{value: val, isSet: true}
}
