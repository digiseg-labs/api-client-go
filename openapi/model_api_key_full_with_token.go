...
type _ApiKeyFullWithToken ApiKeyFullWithToken
...
func (o *ApiKeyFullWithToken) UnmarshalJSON(data []byte) (err error) {
	varApiKeyFullWithToken := _ApiKeyFullWithToken{}

	err = json.Unmarshal(data, &varApiKeyFullWithToken)

	if err != nil {
		return err
	}

	*o = ApiKeyFullWithToken(varApiKeyFullWithToken)
