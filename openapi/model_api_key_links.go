...
func (o *ApiKeyLinks) UnmarshalJSON(data []byte) (err error) {
	varApiKeyLinks := _ApiKeyLinks{}

	err = json.Unmarshal(data, &varApiKeyLinks)

	if err != nil {
		return err
	}

	*o = ApiKeyLinks(varApiKeyLinks)
