...
// checks if the CampaignBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignBase{}

// CampaignBase struct for CampaignBase
...
func (o CampaignBase) MarshalJSON() ([]byte, error) {
...
func (o CampaignBase) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignBase struct {
	value *CampaignBase
	isSet bool
}

func (v NullableCampaignBase) Get() *CampaignBase {
	return v.value
}

func (v *NullableCampaignBase) Set(val *CampaignBase) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignBase) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignBase(val *CampaignBase) *NullableCampaignBase {
	return &NullableCampaignBase{value: val, isSet: true}
}

func (v NullableCampaignBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
