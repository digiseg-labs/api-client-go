...
type _CampaignCreationData CampaignCreationData
...
func (o *CampaignCreationData) UnmarshalJSON(data []byte) (err error) {
	...
	varCampaignCreationData := _CampaignCreationData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCampaignCreationData)

	if err != nil {
		return err
	}

	*o = CampaignCreationData(varCampaignCreationData)
