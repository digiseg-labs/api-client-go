...
// checks if the CampaignIntegrationPlatform type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignIntegrationPlatform{}
...
func NewCampaignIntegrationPlatform() *CampaignIntegrationPlatform {
	this := CampaignIntegrationPlatform{}
	return &this
}
...
func (o CampaignIntegrationPlatform) MarshalJSON() ([]byte, error) {
...
func (o CampaignIntegrationPlatform) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignIntegrationPlatform struct {
	value *CampaignIntegrationPlatform
	isSet bool
}

func (v NullableCampaignIntegrationPlatform) Get() *CampaignIntegrationPlatform {
	return v.value
}

func (v *NullableCampaignIntegrationPlatform) Set(val *CampaignIntegrationPlatform) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignIntegrationPlatform) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignIntegrationPlatform) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignIntegrationPlatform(val *CampaignIntegrationPlatform) *NullableCampaignIntegrationPlatform {
	return &NullableCampaignIntegrationPlatform{value: val, isSet: true}
}

func (v NullableCampaignIntegrationPlatform) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignIntegrationPlatform) UnmarshalJSON(src []byte) error {
	v.isSet = true
