...
type _ComparisonsContainer ComparisonsContainer
...
func (o *ComparisonsContainer) UnmarshalJSON(data []byte) (err error) {
	varComparisonsContainer := _ComparisonsContainer{}

	err = json.Unmarshal(data, &varComparisonsContainer)

	if err != nil {
		return err
	}

	*o = ComparisonsContainer(varComparisonsContainer)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "comparisons")
