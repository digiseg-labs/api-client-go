...
type _CreateApiKey201Response CreateApiKey201Response
...
func (o *CreateApiKey201Response) UnmarshalJSON(data []byte) (err error) {
	varCreateApiKey201Response := _CreateApiKey201Response{}

	err = json.Unmarshal(data, &varCreateApiKey201Response)

	if err != nil {
		return err
	}

	*o = CreateApiKey201Response(varCreateApiKey201Response)
