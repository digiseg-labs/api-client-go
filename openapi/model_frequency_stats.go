...
type _FrequencyStats FrequencyStats
...
func (o *FrequencyStats) UnmarshalJSON(data []byte) (err error) {
	varFrequencyStats := _FrequencyStats{}

	err = json.Unmarshal(data, &varFrequencyStats)

	if err != nil {
		return err
	}

	*o = FrequencyStats(varFrequencyStats)
