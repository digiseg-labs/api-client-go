...
type _HourOfDayStats HourOfDayStats
...
func (o *HourOfDayStats) UnmarshalJSON(data []byte) (err error) {
	varHourOfDayStats := _HourOfDayStats{}

	err = json.Unmarshal(data, &varHourOfDayStats)

	if err != nil {
		return err
	}

	*o = HourOfDayStats(varHourOfDayStats)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "00")
		delete(additionalProperties, "01")
		delete(additionalProperties, "02")
		delete(additionalProperties, "03")
		delete(additionalProperties, "04")
		delete(additionalProperties, "05")
		delete(additionalProperties, "06")
		delete(additionalProperties, "07")
		delete(additionalProperties, "08")
		delete(additionalProperties, "09")
