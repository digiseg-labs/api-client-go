...
type _IdentifyableObject IdentifyableObject
...
func (o *IdentifyableObject) UnmarshalJSON(data []byte) (err error) {
	varIdentifyableObject := _IdentifyableObject{}

	err = json.Unmarshal(data, &varIdentifyableObject)

	if err != nil {
		return err
	}

	*o = IdentifyableObject(varIdentifyableObject)
