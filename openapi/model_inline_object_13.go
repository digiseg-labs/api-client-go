...
type InlineObject13 struct {
	Data *AudienceRecommendationResponseMessage `json:"data,omitempty"`
...
func (o *InlineObject13) GetData() AudienceRecommendationResponseMessage {
	if o == nil || IsNil(o.Data) {
		var ret AudienceRecommendationResponseMessage
		return ret
	}
	return *o.Data
}
...
func (o *InlineObject13) GetDataOk() (*AudienceRecommendationResponseMessage, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *InlineObject13) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given AudienceRecommendationResponseMessage and assigns it to the Data field.
func (o *InlineObject13) SetData(v AudienceRecommendationResponseMessage) {
	o.Data = &v
}
