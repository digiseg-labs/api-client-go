...
type InlineObject5 struct {
	Data *SubscriptionOfferFull `json:"data,omitempty"`
...
// SetData gets a reference to the given SubscriptionOfferFull and assigns it to the Data field.
