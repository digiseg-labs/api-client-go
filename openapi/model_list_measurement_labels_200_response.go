...
// checks if the ListMeasurementLabels200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListMeasurementLabels200Response{}
...
type _ListMeasurementLabels200Response ListMeasurementLabels200Response
...
func NewListMeasurementLabels200Response() *ListMeasurementLabels200Response {
	this := ListMeasurementLabels200Response{}
	return &this
}
...
func (o ListMeasurementLabels200Response) MarshalJSON() ([]byte, error) {
...
func (o ListMeasurementLabels200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListMeasurementLabels200Response) UnmarshalJSON(data []byte) (err error) {
	varListMeasurementLabels200Response := _ListMeasurementLabels200Response{}

	err = json.Unmarshal(data, &varListMeasurementLabels200Response)

	if err != nil {
		return err
	}

	*o = ListMeasurementLabels200Response(varListMeasurementLabels200Response)
...
type NullableListMeasurementLabels200Response struct {
	value *ListMeasurementLabels200Response
	isSet bool
}

func (v NullableListMeasurementLabels200Response) Get() *ListMeasurementLabels200Response {
	return v.value
}

func (v *NullableListMeasurementLabels200Response) Set(val *ListMeasurementLabels200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListMeasurementLabels200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListMeasurementLabels200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListMeasurementLabels200Response(val *ListMeasurementLabels200Response) *NullableListMeasurementLabels200Response {
	return &NullableListMeasurementLabels200Response{value: val, isSet: true}
}

func (v NullableListMeasurementLabels200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListMeasurementLabels200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
