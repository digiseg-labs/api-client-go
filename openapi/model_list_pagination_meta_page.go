...
func (o *ListPaginationMetaPage) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varListPaginationMetaPage)
	...
	*o = ListPaginationMetaPage(varListPaginationMetaPage)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "first_cursor")
		delete(additionalProperties, "last_cursor")
		delete(additionalProperties, "rangeTruncated")
