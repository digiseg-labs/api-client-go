...
type _ListStudies200Response ListStudies200Response
...
func (o *ListStudies200Response) UnmarshalJSON(data []byte) (err error) {
	varListStudies200Response := _ListStudies200Response{}

	err = json.Unmarshal(data, &varListStudies200Response)

	if err != nil {
		return err
	}

	*o = ListStudies200Response(varListStudies200Response)
