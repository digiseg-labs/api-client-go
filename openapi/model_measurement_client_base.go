...
type _MeasurementClientBase MeasurementClientBase
...
func (o *MeasurementClientBase) UnmarshalJSON(data []byte) (err error) {
	varMeasurementClientBase := _MeasurementClientBase{}

	err = json.Unmarshal(data, &varMeasurementClientBase)

	if err != nil {
		return err
	}

	*o = MeasurementClientBase(varMeasurementClientBase)
