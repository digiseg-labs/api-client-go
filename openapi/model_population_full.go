...
type _PopulationFull PopulationFull
...
func (o *PopulationFull) UnmarshalJSON(data []byte) (err error) {
	varPopulationFull := _PopulationFull{}

	err = json.Unmarshal(data, &varPopulationFull)

	if err != nil {
		return err
	}

	*o = PopulationFull(varPopulationFull)
