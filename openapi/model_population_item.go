...
// checks if the PopulationItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PopulationItem{}
...
type _PopulationItem PopulationItem
...
func (o PopulationItem) MarshalJSON() ([]byte, error) {
...
func (o PopulationItem) ToMap() (map[string]interface{}, error) {
...
func (o *PopulationItem) UnmarshalJSON(data []byte) (err error) {
	...
	varPopulationItem := _PopulationItem{}

	err = json.Unmarshal(data, &varPopulationItem)

	if err != nil {
		return err
	}

	*o = PopulationItem(varPopulationItem)
...
type NullablePopulationItem struct {
	value *PopulationItem
	isSet bool
}

func (v NullablePopulationItem) Get() *PopulationItem {
	return v.value
}

func (v *NullablePopulationItem) Set(val *PopulationItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePopulationItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePopulationItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePopulationItem(val *PopulationItem) *NullablePopulationItem {
	return &NullablePopulationItem{value: val, isSet: true}
}

func (v NullablePopulationItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePopulationItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
