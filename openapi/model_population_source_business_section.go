...
type _PopulationSourceBusinessSection PopulationSourceBusinessSection
...
func (o *PopulationSourceBusinessSection) UnmarshalJSON(data []byte) (err error) {
	varPopulationSourceBusinessSection := _PopulationSourceBusinessSection{}

	err = json.Unmarshal(data, &varPopulationSourceBusinessSection)

	if err != nil {
		return err
	}

	*o = PopulationSourceBusinessSection(varPopulationSourceBusinessSection)
