...
func (o *PopulationSourcePrivateCategorySetIncome) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPopulationSourcePrivateCategorySetIncome)
	...
	*o = PopulationSourcePrivateCategorySetIncome(varPopulationSourcePrivateCategorySetIncome)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "h1")
		delete(additionalProperties, "h2")
		delete(additionalProperties, "h3")
		delete(additionalProperties, "h4")
		delete(additionalProperties, "h5")
