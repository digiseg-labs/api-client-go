...
type _RegistrationByIdResponseData RegistrationByIdResponseData
...
func (o *RegistrationByIdResponseData) UnmarshalJSON(data []byte) (err error) {
	varRegistrationByIdResponseData := _RegistrationByIdResponseData{}

	err = json.Unmarshal(data, &varRegistrationByIdResponseData)

	if err != nil {
		return err
	}

	*o = RegistrationByIdResponseData(varRegistrationByIdResponseData)
