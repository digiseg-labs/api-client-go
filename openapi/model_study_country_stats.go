...
type _StudyCountryStats StudyCountryStats
...
func (o *StudyCountryStats) UnmarshalJSON(data []byte) (err error) {
	varStudyCountryStats := _StudyCountryStats{}

	err = json.Unmarshal(data, &varStudyCountryStats)

	if err != nil {
		return err
	}

	*o = StudyCountryStats(varStudyCountryStats)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "predominant_country")
