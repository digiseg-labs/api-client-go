...
type StudyFull struct {
	...
	AiSummary *StudyAISummary `json:"ai_summary,omitempty"`
...
// SetAiSummary gets a reference to the given StudyAISummary and assigns it to the AiSummary field.
