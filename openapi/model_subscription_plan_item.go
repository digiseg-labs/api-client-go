...
// checks if the SubscriptionPlanItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionPlanItem{}
...
type _SubscriptionPlanItem SubscriptionPlanItem
...
func (o SubscriptionPlanItem) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionPlanItem) ToMap() (map[string]interface{}, error) {
...
func (o *SubscriptionPlanItem) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPlanItem := _SubscriptionPlanItem{}

	err = json.Unmarshal(data, &varSubscriptionPlanItem)

	if err != nil {
		return err
	}

	*o = SubscriptionPlanItem(varSubscriptionPlanItem)
...
type NullableSubscriptionPlanItem struct {
	value *SubscriptionPlanItem
	isSet bool
}

func (v NullableSubscriptionPlanItem) Get() *SubscriptionPlanItem {
	return v.value
}

func (v *NullableSubscriptionPlanItem) Set(val *SubscriptionPlanItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionPlanItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionPlanItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionPlanItem(val *SubscriptionPlanItem) *NullableSubscriptionPlanItem {
	return &NullableSubscriptionPlanItem{value: val, isSet: true}
}

func (v NullableSubscriptionPlanItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionPlanItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
