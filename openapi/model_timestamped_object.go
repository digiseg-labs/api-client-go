...
type _TimestampedObject TimestampedObject
...
func (o *TimestampedObject) UnmarshalJSON(data []byte) (err error) {
	varTimestampedObject := _TimestampedObject{}

	err = json.Unmarshal(data, &varTimestampedObject)

	if err != nil {
		return err
	}

	*o = TimestampedObject(varTimestampedObject)
