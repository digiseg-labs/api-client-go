...
// checks if the UserAccountMembershipIncludeAux type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserAccountMembershipIncludeAux{}

// UserAccountMembershipIncludeAux Additional properties that may appear as read-only properties depending on the `include` parameter
type UserAccountMembershipIncludeAux struct {
	Account *AccountFull `json:"account,omitempty"`
...
type _UserAccountMembershipIncludeAux UserAccountMembershipIncludeAux
...
func NewUserAccountMembershipIncludeAux() *UserAccountMembershipIncludeAux {
	this := UserAccountMembershipIncludeAux{}
	return &this
}
...
// SetAccount gets a reference to the given AccountFull and assigns it to the Account field.
...
func (o UserAccountMembershipIncludeAux) MarshalJSON() ([]byte, error) {
...
func (o UserAccountMembershipIncludeAux) ToMap() (map[string]interface{}, error) {
...
func (o *UserAccountMembershipIncludeAux) UnmarshalJSON(data []byte) (err error) {
	varUserAccountMembershipIncludeAux := _UserAccountMembershipIncludeAux{}

	err = json.Unmarshal(data, &varUserAccountMembershipIncludeAux)

	if err != nil {
		return err
	}

	*o = UserAccountMembershipIncludeAux(varUserAccountMembershipIncludeAux)
...
type NullableUserAccountMembershipIncludeAux struct {
	value *UserAccountMembershipIncludeAux
	isSet bool
}

func (v NullableUserAccountMembershipIncludeAux) Get() *UserAccountMembershipIncludeAux {
	return v.value
}

func (v *NullableUserAccountMembershipIncludeAux) Set(val *UserAccountMembershipIncludeAux) {
	v.value = val
	v.isSet = true
}

func (v NullableUserAccountMembershipIncludeAux) IsSet() bool {
	return v.isSet
}

func (v *NullableUserAccountMembershipIncludeAux) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserAccountMembershipIncludeAux(val *UserAccountMembershipIncludeAux) *NullableUserAccountMembershipIncludeAux {
	return &NullableUserAccountMembershipIncludeAux{value: val, isSet: true}
}

func (v NullableUserAccountMembershipIncludeAux) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserAccountMembershipIncludeAux) UnmarshalJSON(src []byte) error {
	v.isSet = true
