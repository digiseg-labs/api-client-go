...
// checks if the UserCreationNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserCreationNotification{}

// UserCreationNotification struct for UserCreationNotification
type UserCreationNotification struct {
	// Whether or not to notify the user that they have been registered
	NotifyUser *bool `json:"notify_user,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UserCreationNotification UserCreationNotification
...
func (o UserCreationNotification) MarshalJSON() ([]byte, error) {
...
func (o UserCreationNotification) ToMap() (map[string]interface{}, error) {
...
func (o *UserCreationNotification) UnmarshalJSON(data []byte) (err error) {
	varUserCreationNotification := _UserCreationNotification{}

	err = json.Unmarshal(data, &varUserCreationNotification)

	if err != nil {
		return err
	}

	*o = UserCreationNotification(varUserCreationNotification)
...
type NullableUserCreationNotification struct {
	value *UserCreationNotification
	isSet bool
}

func (v NullableUserCreationNotification) Get() *UserCreationNotification {
	return v.value
}

func (v *NullableUserCreationNotification) Set(val *UserCreationNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableUserCreationNotification) IsSet() bool {
	return v.isSet
}

func (v *NullableUserCreationNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserCreationNotification(val *UserCreationNotification) *NullableUserCreationNotification {
	return &NullableUserCreationNotification{value: val, isSet: true}
}

func (v NullableUserCreationNotification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserCreationNotification) UnmarshalJSON(src []byte) error {
	v.isSet = true
