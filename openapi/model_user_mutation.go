...
type _UserMutation UserMutation
...
func (o *UserMutation) UnmarshalJSON(data []byte) (err error) {
	varUserMutation := _UserMutation{}

	err = json.Unmarshal(data, &varUserMutation)

	if err != nil {
		return err
	}

	*o = UserMutation(varUserMutation)
